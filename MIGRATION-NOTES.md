...
5. **Cadangan Data (Backup)**: Dulu menggunakan skrip cron `pg_dump` ke penyimpanan lokal. Sekarang ditangani otomatis oleh fitur backup Supabase (Point-in-Time Recovery dan Daily Backups). Cloudflare Workers Cron Trigger disiapkan untuk *cleanup* kustom jika diperlukan.
